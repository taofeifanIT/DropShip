...
import { products, listing, update, deleteItem, downloadCsv, show } from '../../services/distributors/ingramMicro'
    ...
    return (
        <>
            ...
            <ProTable<GithubIssueItem>
                ...
                size="small"
                bordered
                columns={columns({updateApi: update, listingApi: listing, deleteApi: deleteItem}, refresh, true)}
                actionRef={actionRef}
                formRef={ref}
                request={async (
                    params = {},
