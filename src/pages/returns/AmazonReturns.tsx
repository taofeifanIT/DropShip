    ...
    },
    {
        ...
        render: (_,record:{
            ...
            return (
                <>
                     <Space direction="vertical">
                        <Text type="secondary">Quantity : <Text>{record.ReturnQuantity}</Text></Text>
                        <Text type="secondary">Reason : <Text>{record.ReturnReason}</Text></Text>
                    </Space>
                </>
            )
        }
    },
    {
        ...
        render: (_,record:{
            ...
            return (
                <>
                     <Space direction="vertical">
                        <Text type="secondary">Amount : <Text>{record.OrderAmount}</Text></Text>
                        <Text type="secondary">Quantity : <Text>{record.OrderQuantity}</Text></Text>
                    </Space>
                </>
            )
        }
    ...
    return (
        <>
            <ProTable
                ...
                headerTitle={<><WarningOutlined  /> AmazonReturns</>}
            />
        </>
    );
};