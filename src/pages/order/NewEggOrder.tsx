            ...
            return (
                <>
                     <Space direction="vertical">
                        <Text type="secondary">Newegg: <a target='_blank' href={`${getNewEggHref(record.NeweggItemNumber)}`}>{record.NeweggItemNumber}</a></Text>
                        <Text type="secondary">SellerPartNumber : <Text>{record.SellerPartNumber}</Text></Text>
                        <Text type="secondary">OrderNumber : <Text>{record.order_newegg.OrderNumber}</Text></Text>
    ...
    },
    {
        ...
        render: (_,record:{
            ...
            return (
                <>
                     <Space direction="vertical">
                        <Text type="secondary">CustomerName : <Text copyable>{record.CustomerName}</Text></Text>
                        <Text type="secondary">CustomerPhoneNumber : <Text copyable>{record.CustomerPhoneNumber}</Text></Text>
                        <Text type="secondary">CustomerEmailAddress : <Text copyable>{record.CustomerEmailAddress}</Text></Text>
                        <Text type="secondary">ShipToAddress1 : <Text copyable>{record.ShipToAddress1}</Text></Text>
                        <Text type="secondary">ShipToAddress2 : <Text copyable>{record.ShipToAddress2}</Text></Text>
                        <Text type="secondary">ShipToCityName : <Text copyable>{record.ShipToCityName}</Text></Text>
                        <Text type="secondary">ShipToStateCode : <Text copyable>{record.ShipToStateCode}</Text></Text>
                        <Text type="secondary">ShipToZipCode : <Text copyable>{record.ShipToZipCode}</Text></Text>
                        <Text type="secondary">ShipToCountryCode : <Text copyable>{record.ShipToCountryCode}</Text></Text>
                        <Text type="secondary">ShipService : <Text copyable>{record.ShipService}</Text></Text>
                        <Text type="secondary">ShipToFirstName : <Text copyable>{record.ShipToFirstName}</Text></Text>
                        <Text type="secondary">ShipToLastName : <Text copyable>{record.ShipToLastName}</Text></Text>
                        {/* <Text type="secondary">
    ...
    },
    {
        ...
        render: (_,record:{
            ...
            return (
                <>
                     <Space direction="vertical">
                        <Text type="secondary">Order Date : <Text>{moment(parseInt(record.order_newegg.OrderDate + '000')).format("YYYY-MM-DD HH:mm:ss")}</Text></Text>
